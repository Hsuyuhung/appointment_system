...
public enum AppointmentSystemRtnCode {
	...
	SUCCESSFUL("200", "ID建立成功"), 
	ID_NULL("400", "ID不得為空"), 
	ID_FAIL("400", "ID格式錯誤"),
	ID_EXIST("400", "ID已經存在 無法建立"), 
	ID_EMPTY("400", "查無此ID"), 
	PASSWORD_NULL("400", "password輸入為NULL"),
	PASSWORD_FAIL("400", "PASSWORD格式錯誤"), 
	PASSWORD_ERROR("400", "PASSWORD輸入錯誤"), 
	PASSWORD_UNREPEAT("400", "NEWPASSWORD &PASSWORD不可以一樣"), 
