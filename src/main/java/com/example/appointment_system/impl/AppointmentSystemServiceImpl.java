...
//			String week, String medical, String createTime, String email, String birthday) {
//
//		// 判斷輸入的值格式是否正確
//		AppointmentSystemRes creatAppointmentSystemParams = creatAppointmentSystemParams(patientId, doctorId,
//				appointmentTime,week,email,birthday);
//		if (creatAppointmentSystemParams != null) {
//			return creatAppointmentSystemParams;
//		}
//
//        //在資料庫中取得病人的資訊
//		Optional<Patient> patientOp = patientDao.findById(patientId);
...
//		}
//		//用list接出符合資格的預約內容 
//		List<Appointment> appointmentTimeList = appointmentDao.findByDoctorIdAndAppointmentTimeAndWeek(doctorId, appointmentTime,
//				week);
//		//size 計算多少人數在個診間
...
//		Appointment Appointment = new Appointment(patientId, doctorId, appointmentTime, week, medical, createTime,email, birthday);
//		appointmentDao.save(Appointment);
//		return new AppointmentSystemRes(Appointment, AppointmentSystemRtnCode.CREATE_SUCCESSFUL.getMessage());
//	}
//	}
//	// ------------------------判斷輸入是否有值--------------------------//
//	private AppointmentSystemRes creatAppointmentSystemParams(String patientId, String doctorId,
//			String appointmentTime,String week, String email, String birthday) {
//	
//		// ------------------------判斷輸入是否有值--------------------------//
...
//	搜尋預約
	...
	public AppointmentSystemRes findAppointment(String patientId) {
		...
		for (int i = 0; i < appointmentList.size(); i++) {
			AppoinmentInfo appoinmentInfo = new AppoinmentInfo(appointmentList.get(i).getAutoId(), appointmentList.get(i).getHospitalName(),
					doctorList.get(i), appointmentList.get(i).getAppointmentDate(), appointmentList.get(i).getWeek(),
