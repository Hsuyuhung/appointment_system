...
//	搜尋預約
	...
	public AppointmentSystemRes findAppointment( HttpSession httpSession) {

		Patient patient  = (Patient) httpSession.getAttribute("patientInfo");
		String patientId = patient.getPatientId();
		if (patientId != null) {
			return appointmentSystemService.findAppointment(patientId);
		}
		return new AppointmentSystemRes(AppointmentSystemRtnCode.ID_NULL.getMessage());
	}
...
//	刪除預約
	...
	public AppointmentSystemRes deleteAppointment(@RequestBody AppointmentSystemReq req, HttpSession httpSession) {
